    ...
    var PortfolioService = function (eb, address) {
        ...
        this.getPortfolio = function (resultHandler) {
            ...
            if (__args.length === 1 && typeof __args[0] === 'function') {
                ...
                j_eb.send(j_address, {}, {"action": "getPortfolio"}, function (err, result) {
        ...
        this.buy = function (amount, quote, resultHandler) {
            ...
            if (__args.length === 3 && typeof __args[0] === 'number' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
                ...
                j_eb.send(j_address, {
                    "amount": __args[0],
                    "quote": __args[1]
                }, {"action": "buy"}, function (err, result) {
        ...
        this.sell = function (amount, quote, resultHandler) {
            ...
            if (__args.length === 3 && typeof __args[0] === 'number' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
                ...
                j_eb.send(j_address, {
                    "amount": __args[0],
                    "quote": __args[1]
                }, {"action": "sell"}, function (err, result) {
                    __args[2](err, result && result.body);
                });
                return;
            } else throw new TypeError('function invoked with invalid arguments');
        ...
        this.evaluate = function (resultHandler) {
            ...
            if (__args.length === 1 && typeof __args[0] === 'function') {
                ...
                j_eb.send(j_address, {}, {"action": "evaluate"}, function (err, result) {
                    __args[0](err, result && result.body);
                });
                return;
            } else throw new TypeError('function invoked with invalid arguments');
